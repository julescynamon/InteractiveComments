...
passwordSchema
    ...
    .has()
    .uppercase(1) // Doit avoir des lettres mmajuscules
    .has()
    .lowercase(1) // Doit avoir des lettres minuscules
    .has()
    .digits(2) // Doit avoir au moins 1 chiffres
    .has()
    .not()
    .spaces() // Ne doit pas avoir d'espaces
    .is()
    .not()
    .oneOf(['Passw0rd', 'Password123']); // Blacklist des mots de pass
